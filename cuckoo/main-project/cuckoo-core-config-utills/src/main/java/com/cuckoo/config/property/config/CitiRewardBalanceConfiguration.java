...
public class CitiRewardBalanceConfiguration {
	...
	public Map<String,String> getPropValues() throws IOException {
		...
		try {
			...
			configMap.put("linkageEndpoint", prop.getProperty("city.linkage.url.endpoint"));
			configMap.put("redemptionEndpoint", prop.getProperty("city.redemption.url.endpoint"));
...
//			configMap.put("authorization", att);// generated by the "/clientCredentials/oauth2/token/us/gcb" --https://sandbox.developerhub.citi.com/api/united-states/retail-bank/identity-security/authorize/documentation
